  ...
  Widget build(BuildContext context) {
    ...
    child: Padding(
      ...
      child: Column(
       crossAxisAlignment: CrossAxisAlignment.start ,
       children: [
       const  Text("Late",style: TextStyle(fontSize: 17),),
       const  SizedBox(height: 10,),
         Container(
             ...
             child: ListTile(
               ...
               subtitle:const Text("20:15 april 29",style: TextStyle(color: Colors.red,
               fontSize: 18
               ),),
         ...
         const  SizedBox(height: 10,),
            const  Text("today",style: TextStyle(fontSize: 17),),
...
class CheckBoxTodo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
     ...
     child: ListTile(
       title:const Text("Call Max"),
       subtitle:const Text("19:15 ",style: TextStyle(color: Color.fromARGB(255, 82, 79, 78),
       fontSize: 18
       ),),
       trailing: Checkbox(value: true, onChanged:(value) {},),
     ),
